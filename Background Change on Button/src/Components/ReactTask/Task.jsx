...
export const Task = () => {
  ...
  return (
    <div className="main" style={{ backgroundColor: `${backgroundColor}` }}>
      ...
      <div>
      {firstToggle?"YES":"NO"}<Switch style={{ color: "#1ABC9C" }} defaultChecked onChange={()=>setFirstToggle(!firstToggle)}/> 
      <Switch style={{ color: "#D64B4B" }} onChange={()=>setSecondToggle(!SecondToggle)} />{SecondToggle?"NO":"YES"}
